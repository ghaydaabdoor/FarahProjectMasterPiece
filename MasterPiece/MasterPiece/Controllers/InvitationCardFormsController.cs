...
namespace MasterPiece.Controllers
{
    public class InvitationCardFormsController : Controller
    {
        ...
        public ActionResult Edit([Bind(Include = "InvitationCardFormId,UserId,CardDesignId,GroomName,BrideName,WeddingDate,Venue,AdditionalNotes,TimeFrom,TimeTo")] InvitationCardForm form)
        {
